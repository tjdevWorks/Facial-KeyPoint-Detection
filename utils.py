"""
Helper functions obtained from blog post linked below
Credits:
...
def plot_data(img, landmarks, axis=None, trtest="train"):
    """
    ...
    if axis is None:
        ...
        axis.set_title("Sample {} Image".format(trtest))
        notbook=True
    ...
    if notbook:
        plt.show()
        fig.savefig('sample_{}.png'.format(trtest))
